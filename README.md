...
## Features
* Sustainability Rating: Provides a sustainability rating (in percent) for products based on their descriptions along with a short reasoning for this value
